   ...
   WritableImage imagePie; 
    ...
    final String fThree = "F3";
       final CategoryAxis xAxis = new CategoryAxis();
        ...
        series1.getData().add(new XYChart.Data(aPlus, 25601.34));
        series1.getData().add(new XYChart.Data(a, 25601.34));
        series1.getData().add(new XYChart.Data(aMinus, 25601.34));
        series1.getData().add(new XYChart.Data(bPlus, 25601.34));
        series1.getData().add(new XYChart.Data(b, 20148.82));
        series1.getData().add(new XYChart.Data(bMinus, 25601.34));
        series1.getData().add(new XYChart.Data(cPlus, 25601.34));
        series1.getData().add(new XYChart.Data(c, 10000));
        series1.getData().add(new XYChart.Data(fOne, 35407.15));
        series1.getData().add(new XYChart.Data(fTwo, 12000));   
        series1.getData().add(new XYChart.Data(fThree, 25601.34));
        
        XYChart.Series series2 = new XYChart.Series();
        series2.setName("2004");
         series2.getData().add(new XYChart.Data(aPlus, 25601.34));
        series2.getData().add(new XYChart.Data(a, 25601.34));
        series2.getData().add(new XYChart.Data(aMinus, 25601.34));
        series2.getData().add(new XYChart.Data(bPlus, 25601.34));
        series2.getData().add(new XYChart.Data(b, 20148.82));
        series2.getData().add(new XYChart.Data(bMinus, 25601.34));
        series2.getData().add(new XYChart.Data(cPlus, 25601.34));
        series2.getData().add(new XYChart.Data(c, 10000));
        series2.getData().add(new XYChart.Data(fOne, 35407.15));
        series2.getData().add(new XYChart.Data(fTwo, 12000));   
        series2.getData().add(new XYChart.Data(fThree, 25601.34)); 
        
        XYChart.Series series3 = new XYChart.Series();
        series3.setName("2005");
         series3.getData().add(new XYChart.Data(aPlus, 25601.34));
        series3.getData().add(new XYChart.Data(a, 25601.34));
        series3.getData().add(new XYChart.Data(aMinus, 25601.34));
        series3.getData().add(new XYChart.Data(bPlus, 25601.34));
        series3.getData().add(new XYChart.Data(b, 20148.82));
        series3.getData().add(new XYChart.Data(bMinus, 25601.34));
        series3.getData().add(new XYChart.Data(cPlus, 25601.34));
        series3.getData().add(new XYChart.Data(c, 10000));
        series3.getData().add(new XYChart.Data(fOne, 35407.15));
        series3.getData().add(new XYChart.Data(fTwo, 12000));   
        series3.getData().add(new XYChart.Data(fThree, 25601.34)); 
...
return chart;
    ...
    public void initCourse(String course,String name){
